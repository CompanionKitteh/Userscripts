...
- `buyee.jp`
  - [Buyee Arrived Remover.user.js](Buyee%20Arrived%20Remover.user.js)
    - Removes items that are already marked as arrived (or cancelled) from the orders pages (`/myshopping/orders`, `/myurlpurchase/orders`, and `/myorders/bids/successful`)
  - [Buyee Auction Compactifier.user.js](Buyee%20Auction%20Compactifier.user.js)
    - Reformats auction pages (`/item/jdirectitems/auction`) to show information in a more compact way
  ...
  - [Buyee Coupon Deletebuttonizer.user.js](Buyee%20Coupon%20Deletebuttonizer.user.js)
    - Enables the delete button on expired coupons on the claimed coupons page (`/mycoupon/list`)
  - [Buyee Coupon Informationizer.user.js](Buyee%20Coupon%20Informationizer.user.js)
    - Updates coupon titles with more information about the coupon on the coupons pages (`/mycoupon/unissuedlist` and `/mycoupon/list`)
  - [Buyee Coupon Predictor.user.js](Buyee%20Coupon%20Predictor.user.js)
    - Crawls predicted coupon pages to find undistributed coupons on the unclaimed coupons page (`/mycoupon/unissuedlist`)
  - [~~Buyee Invoice Selectifier.user.js~~](Buyee%20Invoice%20Selectifier.user.js) (deprecated, Buyee has changed this field to a free field)
    - ~~Allows searchable dropdowns on the package page (`/mybaggages/invoice`)~~
